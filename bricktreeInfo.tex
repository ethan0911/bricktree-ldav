...
kd-trees, have also been used in isosurface rendering with the trend of coherent
...
\begin{figure}[h]
  ...
  \caption{\label{fig:tree_comparision}Comparison of an octree, a $N^3$-tree and a Bricktree (2D representation).
...
It is straightforward to construct the Bricktree Forest in parallel. The ``\textit{ospRawToBricks}''
...
which may results in measured bandwidth value that appear to exceed the underlying
