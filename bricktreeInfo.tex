...
rather than by $2^3$. Furthermore, a Bricktree is similar to the $N^3$-tree in terms of  data structure,
...
if no cell of this brick has children. 
...
One would in fact expect each sample to be several times as costly as for  
...
It would be  also interesting to look at the Bricktree structure in GPUs architecture. 
}
