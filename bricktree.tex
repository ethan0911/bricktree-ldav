...
\newcommand{\feng}[1] {\textcolor{black}{#1}}
...
\scriptsize Intel Corporation, Now at NVIDIA %
...
\CCScatlist{
  \CCScatTwelve{Large-scale visualization}{Visu\-al\-iza\-tion techniques}{Progressive Rendering}{Visualization design and evaluation methods};
